...
LAB_S3_RESERVATIONS_DATA_FILE_KEY = "AWS-200-DEV/v3.4/binaries/input/lab-3-dynamoDB/ReservationsData.csv"
LAB_S3_CUSTOMER_REPORT_PREFIX = "AWS-200-DEV/v3.4/binaries/input/lab-3-dynamoDB/CustomerRecord"
